...
export default function EnterpriseDashboardWidget1() {
    ...
    if (!isVisible) return <button onClick={() => setIsVisible(true)}>Show 1</button>;

    return (
        <div className={`p-4 rounded-lg shadow ${theme === 'dark' ? 'bg-slate-800 text-white' : 'bg-white text-slate-800'}`}>
            <h2 className="text-xl font-bold mb-4">Analytics Component 1</h2>
